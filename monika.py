				...
				if msg.toType == 0 or msg.toType == 1 or msg.toType == 2:
					...
					if msg.contentType == 0:
						if cmd == "logout":
							...
							client.sendReplyMessage(msg_id, to, helpMessage)
						elif cmd == "self":
							...
							name = contact.displayName
							link = "https://pa1.narvii.com/6547/d29a5e4bb3405d83fc15cf50ec057f41640618a8_hq.gif"
							client.sendReplyMessage(msg_id, to, helpMessage1)
						elif cmd == "group":
							...
							name = contact.displayName
							link = "https://pa1.narvii.com/6547/d29a5e4bb3405d83fc15cf50ec057f41640618a8_hq.gif"
							client.sendReplyMessage(msg_id, to, helpMessage2)
						elif cmd == "media":
							...
							name = contact.displayName
							link = "https://pa1.narvii.com/6547/d29a5e4bb3405d83fc15cf50ec057f41640618a8_hq.gif"
							client.sendReplyMessage(msg_id, to, helpMessage4)
						elif cmd == "special":
							...
							name = contact.displayName
							link = "https://pa1.narvii.com/6547/d29a5e4bb3405d83fc15cf50ec057f41640618a8_hq.gif"
							client.sendFooter(msg_id, to, helpMessage3)
						elif cmd == "settings":
							if msg._from in admin:
								...
								name = contact.displayName
								link = "https://pa1.narvii.com/6547/d29a5e4bb3405d83fc15cf50ec057f41640618a8_hq.gif"
								client.sendReplyMessage(msg_id, to, helpMessage5)
							...
							name = contact.displayName
							link = "https://pa1.narvii.com/6547/d29a5e4bb3405d83fc15cf50ec057f41640618a8_hq.gif"
							client.sendFooter(msg_id, to, helpTranslate)
							...
							client.sendReplyMessage(msg_id, to, result, [sender])
						elif cmd == "mymid":
							contact = client.getContact(sender)
